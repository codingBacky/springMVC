...
public class BoardFrontController extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	//get, post 형식 어떤걸로 들어오든 Process(request, response) 두 포스트를 호출해라. 메인 프로그램을 톰캣이 가지고 있다가 요청객체와 응답객체를 넘겨주면서 호출되면 doProcess 실행
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		String contextPath = request.getContextPath();//기본경로
